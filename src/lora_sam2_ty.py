# Description: LoRA implementation for the SAM2 model
from sam2_train import build_sam
...
class LoRA_sam2(nn.Module):
    """
    Class that takes the image encoder of SAM2 and add the lora weights to the attentions blocks
    ...
    def __init__(self, sam_model: SAM2Base, rank: int, lora_layer=None):
        ...
        if lora_layer:
            ...
            self.lora_layer = list(sam_model.image_encoder.children())
        ...
        for t_layer_i, blk in enumerate(sam_model.image_encoder.children()):
    ...
    def load_lora_parameters(self, filename: str):
        ...
        Return:
            None: Loads the weights to the LoRA_sam2 class
        """
